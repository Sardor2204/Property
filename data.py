...
#                          START                            #
#############################################################
def addData(message, bot):
    markup = types.ReplyKeyboardMarkup()

    markup.add(types.KeyboardButton(text="Квартира"))
    markup.add(types.KeyboardButton(text='Дом'))
    markup.add(types.KeyboardButton(text="Ком недвижимость"))
    markup.add(types.KeyboardButton(text='Земля'))
    ...
    bot.register_next_step_handler(msg, addTerrain, bot)


def addTerrain(message, bot):
    data = [message.text]
